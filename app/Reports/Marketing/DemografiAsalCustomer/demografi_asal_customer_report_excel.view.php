<?php
    ...
    $sheet1 = "Demografi Asal Customer";
?>
<meta charset="UTF-8">
...
<div sheet-name="<?php echo $sheet1; ?>">
    ...
    <div cell="A2">
        ...
        \koolreport\excel\Text::create(array(
            "text" => 'DEMOGRAFI CUSTOMER (PROVINSI)',
            "excelStyle" => [
                'font' => [
                    'name' => 'Calibri',
                    'bold' => true,
    ...
    <div cell="A3">
        <?php
            PivotTable::create(array(
                "dataSource" => $this->dataStore('marketing_demografi_asal_customer_provinsi_table'),
    ...
    <?php
        PivotTable::create(array(
            "dataSource" => $this->dataStore('marketing_demografi_asal_customer_kota_table'),
            'rowCollapseLevels' => array(0),
            'columnCollapseLevels' => array(0),
            'map' => array(
                'dataHeader' => function($dataField, $fieldInfo) {
