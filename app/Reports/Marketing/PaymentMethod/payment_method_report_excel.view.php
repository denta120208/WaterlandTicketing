...
<div sheet-name="<?php echo $sheet1; ?>">
    ...
    <div cell="A2">
        <?php
            PivotTable::create(array(
                "dataSource" => $this->dataStore('marketing_payment_method_table1'),
    ...
    <div cell="A10">
        <?php
            PivotTable::create(array(
                "dataSource" => $this->dataStore('marketing_payment_method_table2'),
                'rowCollapseLevels' => array(0),
                'columnCollapseLevels' => array(0),
                'map' => array(
                    'dataHeader' => function($dataField, $fieldInfo) {
...
<div sheet-name="<?php echo $sheet2; ?>">
    ...
    <div cell="A2">
        <?php            
            BarChart::create(array(
                "title"=>"Payment Method (SALES) (PER TAHUN)",
                "dataSource" => $this->dataStore('marketing_payment_method_chart_tahun_excel_pdf'),
                "columns" =>[
                    'tahun',
                    "total_sales"
                ],
    ...
    <div cell="A15">
        <?php            
            BarChart::create(array(
                "title"=>"Payment Method (SALES) (PER TIPE BAYAR)",
                "dataSource" => $this->dataStore('marketing_payment_method_chart_tipe_excel_pdf'),
                "columns" =>[
                    'CODE_SALESTYPE_CHAR',
                    "total_sales"
                ],
    ...
    <div cell="K2">
        <?php            
            BarChart::create(array(
                "title"=>"Payment Method (UNIT) (PER TAHUN)",
                "dataSource" => $this->dataStore('marketing_payment_method_chart_tahun_excel_pdf'),
                "columns" =>[
                    'tahun',
                    "total_unit"
    ...
    <div cell="K15">
        <?php            
            BarChart::create(array(
                "title"=>"Payment Method (UNIT) (PER TIPE BAYAR)",
                "dataSource" => $this->dataStore('marketing_payment_method_chart_tipe_excel_pdf'),
                "columns" =>[
                    'CODE_SALESTYPE_CHAR',
                    "total_unit"
