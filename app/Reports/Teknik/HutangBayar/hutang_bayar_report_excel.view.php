...
<div sheet-name="<?php echo $sheet1; ?>">
    ...
    <div cell="A3">
        <?php
        Table::create(array(
            "dataSource" => $this->dataStore('teknik_hutang_bayar_table1'),
            "showFooter"=>"true",
            "columns"=>array(
                ...
                "HUTANG_BAYAR_DEV_COST"=>array(
                    "label" => "Hutang Bayar Per ".date('d M', strtotime('1990-12-31')).' '.(date('Y', strtotime($this->cut_off)) - 1),
                    'type' => 'number',
                    "footer"=>"sum",
                    "footerText"=>"@value"
                ),
                "TERBAYAR_DEV_COST"=>array(
                    "label" => "Terbayar Di ".date('Y', strtotime($this->cut_off)),
                    'type' => 'number',
                    "footer"=>"sum",
                    "footerText"=>"@value"
                ),
                "SISA_HUTANG_DEV_COST"=>array(
                    "label" => "Sisa Hutang Bayar ".date('M Y', strtotime($this->cut_off)),
                    'type' => 'number',
                    "footer"=>"sum",
                    "footerText"=>"@value"
                ),
                ...
                "TERBAYAR_ALL"=>array(
                    "label" => "Terbayar s/d ".date('M Y', strtotime($this->cut_off)),
                    'type' => 'number',
                    "footer"=>"sum",
                    "footerText"=>"@value"
                ),
                "SISA_HUTANG_ALL"=>array(
                    "label" => "Total Sisa Hutang Bayar ".date('M Y', strtotime($this->cut_off)),
                    'type' => 'number',
                    "footer"=>"sum",
                    "footerText"=>"@value"
                ),
                "SERAPAN_NEXT_YEAR"=>array(
                    "label" => (date('Y', strtotime($this->cut_off)) + 1),
                    'type' => 'number',
                    "footer"=>"sum",
                    "footerText"=>"@value"
                ),
    ...
    <div range="N2:O2">
        <?php
        \koolreport\excel\Text::create(array(
            "text" => 'Dev Cost, Izin, Const Cost + Fixed Asset',
            "excelStyle" => [
                'font' => [
                    'name' => 'Calibri',
                    'bold' => true,
