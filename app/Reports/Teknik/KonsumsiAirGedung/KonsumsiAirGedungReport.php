...
namespace App\Reports\Teknik\KonsumsiAirGedung;
...
class KonsumsiAirGedungReport extends \koolreport\KoolReport {
    ...
    function setup()
    {
        $this->teknikkonsumsiairgedungtable1();
        $this->teknikkonsumsiairgedungchart1();
        $this->teknikkonsumsiairgedungchart2();
    }

    function teknikkonsumsiairgedungtable1() {
        ...
        ->pipe($this->dataStore('teknik_konsumsi_air_gedung_table1'));
    }

    function teknikkonsumsiairgedungchart1() {
        $node = $this->src('sqlDataSources');
        $node->query("
        ...
        ->pipe($this->dataStore('teknik_konsumsi_air_gedung_chart1'));

        session(['konsumsiAirGedungYear1Chart1' => (int) date('Y', strtotime($this->params["cut_off"]))]);
        session(['konsumsiAirGedungYear2Chart1' => (int) (date('Y', strtotime($this->params["cut_off"]))-1)]);
        session(['konsumsiAirGedungYear3Chart1' => (int) (date('Y', strtotime($this->params["cut_off"]))-2)]);
    }

    function teknikkonsumsiairgedungchart2() {
        $node = $this->src('sqlDataSources');
        $node->query("
            SELECT BULAN AS BULAN, 
            [:year3], [:year2], [:year1]
        ...
        ->pipe($this->dataStore('teknik_konsumsi_air_gedung_chart2'));

        session(['konsumsiAirGedungYear1Chart2' => (int) date('Y', strtotime($this->params["cut_off"]))]);
        session(['konsumsiAirGedungYear2Chart2' => (int) (date('Y', strtotime($this->params["cut_off"]))-1)]);
        session(['konsumsiAirGedungYear3Chart2' => (int) (date('Y', strtotime($this->params["cut_off"]))-2)]);
    }
}