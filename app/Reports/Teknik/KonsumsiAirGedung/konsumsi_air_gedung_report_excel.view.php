    ...
    <div cell="A2">
        <?php
            PivotTable::create(array(
                "dataSource" => $this->dataStore('teknik_konsumsi_air_gedung_table1'),
    ...
    <div cell="A2">
        <?php
            LineChart::create(array(
                ...
                "dataSource" => $this->dataStore('teknik_konsumsi_air_gedung_chart1'),
                "columns" =>[
                    "BULAN",
    ...
    <div cell="I2">
        <?php
            LineChart::create(array(
                ...
                "dataSource" => $this->dataStore('teknik_konsumsi_air_gedung_chart2'),
                "columns" =>[
                    "BULAN",
