...
namespace App\Reports\FinanceAccounting\AgingScheduleEscrowTahapan;
...
class AgingScheduleEscrowTahapanReport extends \koolreport\KoolReport {
    ...
    function setup()
    {
        $this->aging_schedule_escrow_tahapan_table();
    }

    function aging_schedule_escrow_tahapan_table() {
        ...
        $node->query("
            EXEC sp_boc_aging_schedule_escrow_tahapan @rt_period = :cut_off, @project_no = :project
        ")
        ->params(array(
        ...
        ->pipe($this->dataStore('finance_accounting_aging_schedule_escrow_tahapan_table'));
    }
}
