<?php
    ...
    $sheet1 = "Reschedule & Cuti Pembayaran";
?>
<meta charset="UTF-8">
...
<div sheet-name="<?php echo $sheet1; ?>">
    ...
    <div range="B2:C4">
        <?php
        \koolreport\excel\Text::create(array(
            "text" => 'COLLECTION SEHARUSNYA (SEBELUM PENERAPAN KEBIJAKAN)',
            "excelStyle" => [
                'font' => [
                    'name' => 'Calibri',
                    'bold' => true,
    ...
    <div range="D2:E4">
        <?php
        \koolreport\excel\Text::create(array(
            "text" => 'COLLECTION AKTUAL (SETELAH PENERAPAN KEBIJAKAN)',
            "excelStyle" => [
                'font' => [
                    'name' => 'Calibri',
                    'bold' => true,
    ...
    <div range="H2:I4">
        <?php
        \koolreport\excel\Text::create(array(
            "text" => 'TOTAL UNIT YANG MENERIMA KEBIJAKAN',
            "excelStyle" => [
                'font' => [
                    'name' => 'Calibri',
                    'bold' => true,
    ...
    <div cell="A5">
        <?php
        Table::create(array(
            "dataSource" => $this->dataStore('finance_accounting_reschedule_cuti_pembayaran_table_excel'),
            "showFooter"=>"true",
            "columns"=>array(
                "TITLE"=>array(
