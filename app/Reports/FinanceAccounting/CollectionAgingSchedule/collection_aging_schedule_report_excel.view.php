<?php
    ...
    $sheet1 = "Collection & Aging Schedule";
?>
<meta charset="UTF-8">
...
<div sheet-name="<?php echo $sheet1; ?>">
    ...
    <div cell="A3">
        <?php
        Table::create(array(
            "dataSource" => $this->dataStore('finance_accounting_collection_aging_schedule_excel_table1'),
            // "showFooter"=>"true",
            "columns"=>array(
                "TITLE"=>array(
                    "label" => "",
    ...
    <div cell="A8">
        <?php            
            BarChart::create(array(
                ...
                "dataSource" => $this->dataStore('collection_aging_schedule_excel_chart'),
                "columns" =>[
                    'category',
                    "jumlah"
                ],
    ...
    <div cell="A22">
        <?php
        Table::create(array(
            "dataSource" => $this->dataStore('finance_accounting_collection_aging_schedule_excel_table2'),
            // "showFooter"=>"true",
            "columns"=>array(
                "CARA_BAYAR"=>array(
                    "label" => "CARA BAYAR",
    ...
    <?php for($i = array_search('D', $alphabet); $i <= array_search('F', $alphabet); $i++) { ?>
