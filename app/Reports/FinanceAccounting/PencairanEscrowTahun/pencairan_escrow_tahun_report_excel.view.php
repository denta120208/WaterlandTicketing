...
<div sheet-name="<?php echo $sheet1; ?>">
    ...
    <div range="F2:G2">
        <?php
        \koolreport\excel\Text::create(array(
            "text" => 'TOTAL PENCAIRAN '. strtoupper(date('d M Y', strtotime($this->params['cut_off']))),
            "excelStyle" => [
                'font' => [
                    'name' => 'Calibri', //'Verdana', 'Arial'
                    'bold' => true,
    ...
    <div cell="A3">
        <?php
        Table::create(array(
            "dataSource" => $this->dataStore('finance_accounting_pencairan_escrow_tahun_table'),
            "showFooter"=>"true",
            "columns"=>array(
                "TAHUN_AKAD"=>array(
                    "label" => "TH ESCROW",
