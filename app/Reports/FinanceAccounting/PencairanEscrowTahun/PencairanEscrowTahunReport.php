...
namespace App\Reports\FinanceAccounting\PencairanEscrowTahun;
...
class PencairanEscrowTahunReport extends \koolreport\KoolReport {
    ...
    function setup()
    {
        $this->pencairan_escrow_tahun_table();
    }

    function pencairan_escrow_tahun_table() {
        ...
        $node->query("
            EXEC sp_boc_piutang_sum_blokir_by_year_type @rt_period = :cut_off, @project_no = :project, @bank_id = :bank_id, @bussines_id = :business_id
        ")
        ->params(array(
        ...
        ->pipe($this->dataStore('finance_accounting_pencairan_escrow_tahun_table'));
    }
}
