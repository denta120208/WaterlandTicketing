<?php
    ...
    $sheet1 = "Rev Ticket By Promo";
?>
<meta charset="UTF-8">

<?php if(count($this->dataStore('revenue_ticket_by_promo_table1')->all()) > 0) { ?>
<div sheet-name="<?php echo $sheet1; ?>">
    ...
    <div range="A1:E1">
        <?php
            \koolreport\excel\Text::create(array(
                "text" => "Revenue ".$this->kategori_param." By Promo",
                "excelStyle" => [
                    'font' => [
                        'name' => 'Calibri',
                        'bold' => true,
    ...
    <?php
        Table::create(array(
            "dataSource" => $this->dataStore('revenue_ticket_by_promo_table1'),
            "showFooter"=>"true",
            "columns"=>array(
                "PROMO_DESC_CHAR" => ["label" => "Promo", "formatValue" => function($value, $row) { return $value; }, "footerText" => "TOTAL"],
