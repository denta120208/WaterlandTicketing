<?php
    ...
    $sheet1 = "Revenue Project";
?>
<meta charset="UTF-8">

<?php if(count($this->dataStore('revenue_settings_table1')->all()) > 0) { ?>
<div sheet-name="<?php echo $sheet1; ?>">
    ...
    <?php
        Table::create(array(
            "dataSource" => $this->dataStore('revenue_settings_table1'),
            "showFooter"=>"true",
            "columns"=>array(
                "MD_CATEGORY_REVENUE_NAME" => ["label" => "DtD", "formatValue" => function($value, $row) { return $value; }, "footerText" => "TOTAL"],
