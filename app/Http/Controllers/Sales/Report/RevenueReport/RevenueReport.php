...
namespace App\Http\Controllers\Sales\Report\RevenueReport;
...
class RevenueReport extends \koolreport\KoolReport {
    ...
    function revenuetable1() {
        $node = $this->src('sqlDataSources');
        $node->query("
            EXEC sp_report_revenue @start_date = :start_date_param, @end_date = :end_date_param, @project = :project
        ")
        ->params(array(
        ...
        ->pipe($this->dataStore('revenue_table1'));
    }
}