...
<?php if(count($this->dataStore('pos_details_report_table1')->all()) > 0) { ?>
<div sheet-name="<?php echo $sheet1; ?>">
    ...
    <?php
        Table::create(array(
            "dataSource" => $this->dataStore('pos_details_report_table1'),
            "showFooter" => "true",
            "columns"=>array(
                "TRANS_POS_DETAIL_ID_INT" => ["label" => "No.", "formatValue" => function($value, $row) { return $value; }, "footerText" => "TOTAL"],
                "TRANS_POS_NO_CHAR" => ["label" => "Transaction Number", "formatValue" => function($value, $row) { return $value; }, "footerText" => ""],
                "DESC_CHAR" => ["label" => "Description", "formatValue" => function($value, $row) { return $value; }, "footerText" => ""],
                "QTY_INT" => ["label" => "Qty", "formatValue" => function($value, $row) { return $value == "-" ? "-" : $value; }, "footer" => "sum", "footerText" => "@value"],
                "HARGA_SATUAN_FLOAT" => ["label" => "Unit Price", "formatValue" => function($value, $row) { return $value == "-" ? "-" : $value; }, "footer" => "sum", "footerText" => "@value"],
                "TOTAL_HARGA_FLOAT" => ["label" => "Total Price", "formatValue" => function($value, $row) { return $value == "-" ? "-" : $value; }, "footer" => "sum", "footerText" => "@value"],
