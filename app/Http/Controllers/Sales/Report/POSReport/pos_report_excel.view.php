...
<?php if(count($this->dataStore('pos_report_table1')->all()) > 0) { ?>
<div sheet-name="<?php echo $sheet1; ?>">
    ...
    <?php
        Table::create(array(
            "dataSource" => $this->dataStore('pos_report_table1'),
            "showFooter"=>"true",
            "columns"=>array(
                "TRANS_POS_ID_INT" => ["label" => "No.", "formatValue" => function($value, $row) { return $value; }, "footerText" => "TOTAL"],
                ...
                "TOTAL_PAID_FINAL_FLOAT" => ["label" => "Paid", "formatValue" => function($value, $row) { return $value == "-" ? "-" : $value; }, "footer" => "sum", "footerText" => "@value"],
