...
<?php if(count($this->dataStore('locker_report_table1')->all()) > 0) { ?>
<div sheet-name="<?php echo $sheet1; ?>">
    ...
    <?php
        Table::create(array(
            "dataSource" => $this->dataStore('locker_report_table1'),
            "showFooter"=>"true",
            "columns"=>array(
                "TRANS_RENTAL_LOCKER_ID_INT" => ["label" => "No.", "formatValue" => function($value, $row) { return $value; }, "footerText" => "TOTAL"],
