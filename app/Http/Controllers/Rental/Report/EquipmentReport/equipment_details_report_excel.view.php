<?php
    ...
    $sheet1 = "Equipment Details";
?>
<meta charset="UTF-8">

<?php if(count($this->dataStore('equipment_details_report_table1')->all()) > 0) { ?>
<div sheet-name="<?php echo $sheet1; ?>">
    ...
    <?php
        Table::create(array(
            "dataSource" => $this->dataStore('equipment_details_report_table1'),
            "showFooter" => "true",
            "columns"=>array(
                "TRANS_RENTAL_EQUIPMENT_DETAIL_ID_INT" => ["label" => "No.", "formatValue" => function($value, $row) { return $value; }, "footerText" => "TOTAL"],
                "TRANS_EQUIPMENT_NO_CHAR" => ["label" => "Transaction Number", "formatValue" => function($value, $row) { return $value; }, "footerText" => "-"],
                "MD_EQUIPMENT_WITH_CATEGORY_DESC_CHAR" => ["label" => "Description", "formatValue" => function($value, $row) { return $value; }, "footerText" => "-"],
                "HARGA_FLOAT" => ["label" => "Price", "formatValue" => function($value, $row) { return $value == "-" ? "-" : number_format($value,0,',','.'); }, "footer" => "sum", "footerText" => "@value"],
