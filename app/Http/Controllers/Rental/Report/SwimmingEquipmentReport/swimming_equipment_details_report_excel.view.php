<?php
    ...
    $sheet1 = "Swimming Equipment Details";
?>
<meta charset="UTF-8">

<?php if(count($this->dataStore('swimming_equipment_details_report_table1')->all()) > 0) { ?>
<div sheet-name="<?php echo $sheet1; ?>">
    ...
    <?php
        Table::create(array(
            "dataSource" => $this->dataStore('swimming_equipment_details_report_table1'),
            "showFooter" => "true",
            "columns"=>array(
                "TRANS_RENTAL_PERLENGKAPAN_RENANG_DETAIL_ID_INT" => ["label" => "No.", "formatValue" => function($value, $row) { return $value; }, "footerText" => "TOTAL"],
                ...
                "HARGA_SATUAN_FLOAT" => ["label" => "Price", "formatValue" => function($value, $row) { return $value; }, "footer" => "sum", "footerText" => "@value"],
                "TOTAL_HARGA_FLOAT" => ["label" => "Total Price", "formatValue" => function($value, $row) { return $value; }, "footer" => "sum", "footerText" => "@value"],
