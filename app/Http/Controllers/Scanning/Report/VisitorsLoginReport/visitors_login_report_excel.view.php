<?php
    ...
    $sheet1 = "Visitors Login";
?>
<meta charset="UTF-8">

<?php if(count($this->dataStore('visitors_login_table1')->all()) > 0) { ?>
<div sheet-name="<?php echo $sheet1; ?>">
    ...
    <?php
        Table::create(array(
            "dataSource" => $this->dataStore('visitors_login_table1'),
            "showFooter"=>"true",
            "columns"=>array(
                "TGL" => ["label" => "Date", "type"=>"string", "formatValue" => function($value, $row) { return date('d-m-Y', strtotime($value)); }, "footerText" => "TOTAL"],
                "QTY_TICKET_INT" => ["label" => "Qty", "formatValue" => function($value, $row) { return $value; }, "footer" => "sum", "footerText" => "@value"],
                "QTY_TICKET_FREE_INT" => ["label" => "Qty Free", "formatValue" => function($value, $row) { return $value; }, "footer" => "sum", "footerText" => "@value"],
                "TOTAL_QTY_TICKET" => ["label" => "Total Qty", "formatValue" => function($value, $row) { return $value; }, "footer" => "sum", "footerText" => "@value"],
                "IS_LOGIN" => ["label" => "Total Login", "formatValue" => function($value, $row) { return $value; }, "footer" => "sum", "footerText" => "@value"],
                "IS_NOT_LOGIN" => ["label" => "Total Not Login", "formatValue" => function($value, $row) { return $value; }, "footer" => "sum", "footerText" => "@value"]
            ),
            "excelStyle" => [
