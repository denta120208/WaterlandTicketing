...
@section('navbar_header')
    Form Add Data Letter Of Intent - <b>{{session('current_project_char')}}</b>
@endsection
                                ...
                                <div class="card card-info card-tabs" >
                                    ...
                                    <div class="tab-content" id="custom-tabs-one-tabContent" style="padding-left: 5px; padding-right: 5px;">
                                        ...
                                        <div class="tab-pane fade show active" id="custom-tabs-one-home" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab">
                                            <form action="{{URL::route('marketing.leaseagreement.adddatapsm')}}" method="post">
                                            @csrf
                                            <br>
                                            <div class="row">
                                                <div class="col-lg-4">
                    ...
                    <table class="table table-bordered table-hover dataTable  display compact "
                        ...
                        @foreach($dataLot as $data)
                            <tr>
                                ...
                                <td>{{$data->LOT_STOCK_SQM }}</td>
                                <td>{{$data->LOT_STOCK_SQM_SC}}</td>
                            </tr>
                        @endforeach
                        </tbody>
                    </table>
