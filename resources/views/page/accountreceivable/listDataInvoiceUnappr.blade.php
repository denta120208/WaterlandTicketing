...
@section('navbar_header')
    Form List Invoice Unapprove - <b>{{session('current_project_char')}}</b>
@endsection

@section('header_title')
    Form List Invoice Unapprove
@endsection
                            ...
                            <table class="table-striped table-hover compact" id="rental_payment" cellspacing="0" width="100%">
                                ...
                                @foreach($dataInvoiceRENT as $data)
                                    <tr>
                                        ...
                                        @if($data->ACC_JOURNAL_APPROVED_INT == 1)
                                            <td class="center">
                                        ...
                                        @else
                                            <td class="center">
                                                <a href="#unapproveModal{!!$data->INVOICE_PAYMENT_ID_INT!!}" class="btn btn-sm btn-warning" data-toggle="modal">
                                                    <i>
                                                        Unapprove
                                                    </i>
                                                </a>
                                                <div id="unapproveModal{!!$data->INVOICE_PAYMENT_ID_INT!!}" class="modal fade">
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="form-group">
                                                                    <p>Are you sure unapprove this transaction ?</p>
                                                                </div>
                                                            </div>
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-danger" data-dismiss="modal">No</button>
                                                                <a href="{{ URL('/invoice/unapproveinvoicepayment/'. $data->INVOICE_PAYMENT_ID_INT) }}" class="btn btn-success">Yes</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
