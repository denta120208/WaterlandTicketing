            ...
            <div class="Customer">
                ...
                <p style="text-align:justify;">
                    ...
                    <tr>
                        <td colspan="2">
                            <div class="tableCustomer">
                                <div style="text-align: left;margin-top: -3px;">
                                    {{$dataInvRentUtility[0]->UTILS_TYPE_NAME}} ({{number_format($dataInvRentUtility[0]->BILLING_METER_START_LWBP,0,'','.')}} - {{number_format($dataInvRentUtility[0]->BILLING_METER_END_LWBP,0,'','.')}}) <br>
                                    / {{$dataTenant->MD_TENANT_NPWP}}</div><br>
                        ...
                        <td colspan="2">
                            <div class="tableCustomer">
                                IDR <div style="text-align: right;margin-top: -20px;">{{number_format($dataInvRentUtility[0]->DPP,0,'','.')}}</div><br>
                                IDR <div style="text-align: right;margin-top: -20px;">{{number_format($dataInvRentUtility[0]->PPN,0,'','.')}}</div><br>
                                IDR <div style="text-align: right;margin-top: -20px;">{{number_format($dataInvRentUtility[0]->TOTAL,0,'','.')}}</div><br>
                            </div>
                        </td>
                    </tr>
                    <tr>
