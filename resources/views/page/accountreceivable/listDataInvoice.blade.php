...
@section('navbar_header')
    Form List Invoice - <b>{{session('current_project_char')}}</b>
@endsection
...
<div class="modal fade" id="edit-pph-modal" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
        ...
        <form method="POST" action="{{route('invoice.changepphstatusinvoice')}}">
            @csrf
...
<div class="container-xxl">
    <div class="row justify-content-center">
        <div class="col-md">
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ route('invoice.viewlistdatainvoice') }}">
                        @csrf
                        ...
                        <div class="row" style="padding-left: 5px;">
                            <div class="col-lg-2">
                                <a class="btn btn-success" href="{!! URL::route('invoice.viewadddatainvoicemanual') !!}" role="button">
                                    Add Data Invoice
                                </a>
                            </div>
                            <div class="col-lg-3">
                                <a class="btn btn-success" href="{!! URL::route('invoice.viewadddatarevenuesharing') !!}" role="button">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach($dataInvoice as $data)
                                            <tr>
                                                ...
                                                <td style="text-align: right;">{{number_format($data->DUTY_STAMP,0,'','')}}</td>
                                                <td>{{$data->INVOICE_STATUS_INT}}</td>
                                                @if(($data->INVOICE_STATUS_INT == 'PAID' || $data->INVOICE_STATUS_INT == 'PARTIAL PAYMENT' || $data->INVOICE_STATUS_INT == 'REQ. PAYMENT') && $data->JOURNAL_STATUS_INT == 1)
                                                    <td class="center">
                                                ...
                                                @else
                                                    @if($data->INVOICE_TRANS_TYPE == 'RS')
                                                        <td class="center">
                                                            <a class="btn btn-sm btn-warning" href="{{ URL('/invoice/vieweditdatainvoicerevenuesharing/' . $data->INVOICE_TRANS_ID_INT) }}">
                                                                <i>
                                                                    View/Edit
                                                                </i>
                                                            </a>
                                                    ...
                                                    @else
                                                        <td class="center">
                                                            <a class="btn btn-sm btn-warning" href="{{ URL('/invoice/vieweditdatainvoicemanual/' . $data->INVOICE_TRANS_ID_INT.'/'. $data->DOC_TYPE) }}">
                                                                <i>
                                                                    View/Edit
                                                                </i>
                                                            </a>
                                                    ...
                                                    @endif
                                                @endif
                                                @if($data->INVOICE_STATUS_INT == 'VOID')
                                                    <td class="center">
                                                        <a class="btn btn-sm btn-default" href="javascript:void(0)">
                                                            <i>
                                                                Posting
                                                ...
                                                @else
                                                    @if($data->JOURNAL_STATUS_INT == 0)
                                                        <td class="center">
                                                            <a href="#postingModal{!!$data->INVOICE_TRANS_ID_INT!!}" class="btn btn-sm btn-success pull-left" data-toggle="modal">
                                                                <i>
                                                                    Posting
                                                                </i>
                                                            </a>
                                                            <div id="postingModal{!!$data->INVOICE_TRANS_ID_INT!!}" class="modal fade">
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            ...
                                                                            <a href="{{ URL('/invoice/postinginvoice/'. $data->INVOICE_TRANS_ID_INT) }}" class="btn btn-success">Yes</a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                ...
                                                @else
                                                    ...
                                                    @else
                                                        <td class="center">
                                                            <a class="btn btn-sm btn-info" href="{{ URL('/invoice/printinvoicekwitansi/INV/' . $data->INVOICE_TRANS_ID_INT) }}" onclick="window.open(this.href).print(); return false">
                                                                <i>
                                                                    Invoice
                                                                </i>
                                                            </a>
                                                ...
                                                @endif
                                                @if(($data->INVOICE_STATUS_INT == 'VOID' || $data->INVOICE_STATUS_INT == 'REQ. PAYMENT'))
                                                    <td class="center">
                                                        <a class="btn btn-sm btn-default" href="javascript:void(0)">
                                                            <i>
                                                                Paid
                                                ...
                                                @else
                                                    ...
                                                    @else
                                                        <td class="center">
                                                            <a class="btn btn-sm btn-success" href="{{ URL('/invoice/viewpaidinvoice/' . $data->INVOICE_TRANS_ID_INT) }}">
                                                                <i>
                                                                    Paid
                                                                </i>
                                                            </a>
                                                ...
                                                @else
                                                    <td class="center">
                                                        <a href="#voidModal{!!$data->INVOICE_TRANS_ID_INT!!}" class="btn btn-sm btn-danger" data-toggle="modal">
                                                            <i>
                                                                Void
                                                            </i>
                                                        </a>
                                                        <div id="voidModal{!!$data->INVOICE_TRANS_ID_INT!!}" class="modal fade">
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h4 class="modal-title">Confirmation</h4>
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        <button type="button" class="btn btn-danger" data-dismiss="modal">No</button>
                                                                        <a href="{{ URL('/invoice/voidinvoice/'. $data->INVOICE_TRANS_ID_INT) }}" class="btn btn-success">Yes</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <table class="table table-bordered table-hover dataTable  display compact" id="type_inv_table" style="padding: 0.5em;">
                        ...
                        @endforeach
                        @foreach($secureDepType as $data1)
                            <tr>
                                <td>{{$data1->PSM_SECURE_DEP_TYPE_CODE}}</td>
                                <td>{{$data1->PSM_SECURE_DEP_TYPE_DESC}}</td>
                            </tr>
                        @endforeach
                        </tbody>
                    </table>
