@extends('Sales.Report.revenueTicketByPaymentMethod.pdfcetak')
...
<html>
    ...
    <body>
            ...
            <div>
                <center>
                    <div class="headerbawahtengah">
                        <h1><b><label>Revenue {{$KATEGORI_PARAM}} By Payment Method</label></b></h1>
                        <?php
        ...
        <table class="stripe hover compact" id="data_bill_payment" cellspacing="0" width="100%">
            ...
            <tbody>
            @if(count($dataRevenueTicketByPaymentMethod) > 0)
            <?php $i = 1; $qty = 0; $qtyFree = 0; $totalDisc = 0; $total = 0; ?>
            @foreach($dataRevenueTicketByPaymentMethod as $data)
                <tr>
                    <td style="text-align: left">{{ $i }}</td>
                    <td style="text-align: left">{{ $data['PAYMENT_METHOD_DESC_CHAR'] }}</td>
                    <td style="text-align: right">{{ $data['QTY_TICKET_INT'] }}</td>
                    <td style="text-align: right">{{ $data['TICKET_FREE_INT'] }}</td>
            ...
            <tr>
                    ...
                    <td style="text-align: right; font-size: 120%;"><b>{{ number_format($totalDisc,0,',','.') }}</b></td>
                    <td style="text-align: right; font-size: 120%;"><b>{{ number_format($total,0,',','.') }}</b></td>
                </tr>
            @else
            <tr>
