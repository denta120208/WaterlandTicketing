...
<html>
    ...
    <body>
            ...
            <div>
                <center>
                    <div class="headerbawahtengah">
                        <h1><b><label>POS Details</label></b></h1>
                        <?php
        ...
        <table class="stripe hover compact" id="data_bill_payment" cellspacing="0" width="100%">
            ...
            <tbody>
            @if(count($dataPOSDetails) > 0)
            <?php $qty = 0; $unitprice = 0; $totalprice = 0; ?>
            @foreach($dataPOSDetails as $data)
                <tr>
                    ...
                    <td style="text-align: right;">{{$data['QTY_INT']}}</td>
                ...
                <?php $qty += $data['QTY_INT']; $unitprice += $data['HARGA_SATUAN_FLOAT']; $totalprice += $data['TOTAL_HARGA_FLOAT']; ?>
            @endforeach
            <tr>
                ...
                <td style="text-align: right;"><b>{{number_format($unitprice,0,',','.')}}</b></td>
