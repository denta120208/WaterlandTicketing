@extends('Sales.Report.revenue.pdfcetak')
        ...
        <table class="stripe hover compact" id="data_bill_payment" cellspacing="0" width="100%">
            ...
            @foreach($dataRevenue as $data)
                <tr>
                    ...
                    <td style="text-align: right">{{number_format($data['PAID_BEFORE_PB1'],0,',','.')}}</td>
                    <td style="text-align: right">{{number_format($data['PAID_PB1'],0,',','.')}}</td>
                    <td style="text-align: right">{{number_format($data['PAID'],0,',','.')}}</td>
                    <td style="text-align: right">{{number_format($data['PAID_AVG_BEFORE_PB1'],0,',','.')}}</td>
                    <td style="text-align: right">{{number_format($data['PAID_AVG'],0,',','.')}}</td>
                </tr>
            ...
            <tr>
                    ...
                    <td style="text-align: right; font-size: 120%;"><b>{{ number_format($paidExcPb1,0,',','.') }}</b></td>
                    <td style="text-align: right; font-size: 120%;"><b>{{ number_format($paidPb1,0,',','.') }}</b></td>
                    <td style="text-align: right; font-size: 120%;"><b>{{ number_format($paidIncPb1,0,',','.') }}</b></td>
