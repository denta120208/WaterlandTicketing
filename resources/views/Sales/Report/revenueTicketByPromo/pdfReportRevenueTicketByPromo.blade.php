@extends('Sales.Report.revenueTicketByPromo.pdfcetak')
...
<html>
    ...
    <body>
            ...
            <div>
                <center>
                    <div class="headerbawahtengah">
                        <h1><b><label>Revenue {{$KATEGORI_PARAM}} By Promo</label></b></h1>
                        <?php
        ...
        <table class="stripe hover compact" id="data_bill_payment" cellspacing="0" width="100%">
            ...
            <tbody>
            @if(count($dataRevenueTicketByPromo) > 0)
            <?php $i = 1; $qty = 0; $qtyFree = 0; $totalDisc = 0; $total = 0; ?>
            @foreach($dataRevenueTicketByPromo as $data)
                <tr>
                    <td style="text-align: left">{{ $i }}</td>
                    <td style="text-align: left">{{ $data['PROMO_DESC_CHAR'] }}</td>
