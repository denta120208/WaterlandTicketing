        ...
        <table class="stripe hover compact" id="data_bill_payment" cellspacing="0" width="100%">
            ...
            @foreach($dataVisitors as $data)
                <tr>
                    ...
                    <td style="text-align: right;">{{number_format($data['TOTAL_PRICE_BEFORE_DISCOUNT'], 0, ",", ".")}}</td>
                    <td style="text-align: right;">{{number_format($data['TOTAL_PRICE_NUM'], 0, ",", ".")}}</td>
                    <td style="text-align: right;">{{number_format($data['TOTAL_PAID_NUM'], 0, ",", ".")}}</td>
                    <td style="text-align: right;">{{number_format($data['TOTAL_CHANGE_NUM'], 0, ",", ".")}}</td>
            ...
            <tr>
                ...
                {{-- <td style="text-align: right; font-size: 120%;"><b>{{$discountPercent}}%</b></td> --}}
                <td style="text-align: center; font-size: 120%;"><b></b></td>
                <td style="text-align: right; font-size: 120%;"><b>{{number_format($discountNominal, 0, ",", ".")}}</b></td>
                <td style="text-align: right; font-size: 120%;"><b>{{number_format($totalPriceBefDisc, 0, ",", ".")}}</b></td>
                <td style="text-align: right; font-size: 120%;"><b>{{number_format($totalPrice, 0, ",", ".")}}</b></td>
                <td style="text-align: right; font-size: 120%;"><b>{{number_format($totalPaid, 0, ",", ".")}}</b></td>
                <td style="text-align: right; font-size: 120%;"><b>{{number_format($totalChange, 0, ",", ".")}}</b></td>
                <td style="text-align: center; font-size: 120%;"><b></b></td>
                <td style="text-align: center; font-size: 120%;"><b></b></td>
            </tr>
            @else
            <tr>
                <td style="text-align: center" colspan="15"><b>No data available</b></td>
            </tr>
            @endif
            </tbody>
        </table>
