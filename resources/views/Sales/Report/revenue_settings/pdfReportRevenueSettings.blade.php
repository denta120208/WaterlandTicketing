@extends('Sales.Report.revenue_settings.pdfcetak')
...
<html>
    ...
    <body>
            ...
            <div>
                <center>
                    <div class="headerbawahtengah">
                        <h1><b><label>Revenue Project</label></b></h1>
                        <?php
        ...
        <table class="stripe hover compact" id="data_bill_payment" cellspacing="0" width="100%">
            ...
            <tbody>
            @if(count($dataRevenueSettings) > 0)
            <?php $i = 1; $totalActualToday = 0; $totalBudgetToday = 0; $totalActualYTD = 0; $totalBudgetYTD = 0; ?>
            @foreach($dataRevenueSettings as $data)
                <tr>
                    <td style="text-align: left">{{ $i }}</td>
                    <td style="text-align: left">{{ $data['MD_CATEGORY_REVENUE_NAME'] }}</td>
