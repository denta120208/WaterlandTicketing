...
@section('navbar_header')
    Form Add New Product POS Category - <b>{{session('current_project_char')}}</b>
@endsection

@section('header_title')
    Form Add New Product POS Category
@endsection
...
<div class="container-xxl">
    <div class="row justify-content-center">
        <div class="col-md">
            <div class="card">
                <div class="card-body">
                    <form action="{{ url('add_new_product_pos_category') }}" method="post">
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="col-sm-12">
