...
@section('navbar_header')
    List Group Type Membership - <b>{{session('current_project_char')}}</b>
@endsection
...
<div class="modal fade" id="modal-save">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ url('save_group_type_membership') }}" method="post">
                {{ csrf_field() }}
...
<div class="modal fade" id="modal-edit">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ url('edit_group_type_membership') }}" method="post">
                {{ csrf_field() }}
                <div class="modal-header">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#example1').DataTable({
            ...
            "ajax":{
                "url": "{{ url('listTblGroupTypeMembership') }}",
                "dataType": "json",
                "type": "POST",
