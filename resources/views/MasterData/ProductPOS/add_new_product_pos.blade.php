...
@section('navbar_header')
    Form Add New Product POS - <b>{{session('current_project_char')}}</b>
@endsection

@section('header_title')
    Form Add New Product POS
@endsection
...
<div class="container-xxl">
    <div class="row justify-content-center">
        <div class="col-md">
            <div class="card">
                <div class="card-body">
                    <form action="{{ url('add_new_product_pos') }}" method="post">
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="col-sm-6">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="TXT_NAME" class="form-control" id="TXT_NAME" placeholder="Enter Product Name" required>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
