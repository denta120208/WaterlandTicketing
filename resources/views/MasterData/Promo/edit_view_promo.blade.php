...
@section('navbar_header')
    Form Edit Promo Ticket - <b>{{session('current_project_char')}}</b>
@endsection
...
<div class="container-xxl">
    <div class="row justify-content-center">
        <div class="col-md">
            <div class="card">
                <div class="card-body">
                    <form action="{{ url('edit_promo') }}" method="post">
                        {{ csrf_field() }}
                        <div class="row">
                            <input type="hidden" name="TXT_PROMO_ID" class="form-control" id="TXT_PROMO_ID" value="{{ $dataPromo->PROMO_TICKET_PURCHASE_ID_INT }}" required>
                            <div class="col-sm-6">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="TXT_TICKET_FREE" class="form-control" id="TXT_TICKET_FREE" placeholder="Enter Ticket Free" value="{{ $dataPromo->TICKET_FREE_INT }}" required>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select id="DDL_TICKET_GROUP" name="DDL_TICKET_GROUP" class="form-control select2" style="width: 100%;" required>
                                        ...
                                        <option value="ALL" {{ $dataPromo->MD_GROUP_TICKET_CHAR == "ALL" ? "selected" : "" }}>ALL</option>
                                        @foreach($ddlDataTicketGroup as $data)
                                        <option value="{{ $data->MD_GROUP_TICKET_ID_INT }}" {{ $dataPromo->MD_GROUP_TICKET_CHAR == $data->MD_GROUP_TICKET_ID_INT ? "selected" : "" }}>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select id="DDL_TICKET_PRICE" name="DDL_TICKET_PRICE" class="form-control select2" style="width: 100%;" required>
                                        <option value="">--- Not Selected ---</option>
                                        <option value="ALL" {{ $dataPromo->MD_PRICE_TICKET_CHAR == "ALL" ? "selected" : "" }}>ALL</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-sm-6">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="TXT_MIN_TICKET_QTY" class="form-control" id="TXT_MIN_TICKET_QTY" placeholder="Enter Minimal Ticket Qty" value="{{ $dataPromo->MIN_TICKET_QTY }}" required>
                                    <small><span style="color: red;"><b><i>Jika Tidak Ada Isi Dengan 0</i></b></span></small>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="TXT_MIN_TICKET_PAYMENT" class="form-control" id="TXT_MIN_TICKET_PAYMENT" placeholder="Enter Minimal Ticket Payment" value="{{ (float) $dataPromo->MIN_TICKET_PAYMENT }}" required>
                                    <small><span style="color: red;"><b><i>Jika Tidak Ada Isi Dengan 0</i></b></span></small>
                                </div>
                            </div>
                            <div class="col-sm-6">
