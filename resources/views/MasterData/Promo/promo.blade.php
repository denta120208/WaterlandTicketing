...
@section('navbar_header')
    List Promo Ticket - <b>{{session('current_project_char')}}</b>
@endsection
                        ...
                        <div class="row" style="padding-left: 5px;">
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <a class="form-control btn btn-info" href="{{ route('add_new_promo') }}">
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center;">{{ $data->TICKET_FREE_INT }}</td>
                                        ...
                                        <td style="text-align: center;">{{ $data->MD_GROUP_TICKET_DESC }}</td>
                                        <td style="text-align: center;">{{ $data->MD_PRICE_TICKET_DESC }}</td>
                                        <td style="text-align: center;">{{ $data->PAYMENT_METHOD_DESC_CHAR }}</td>
                                        <td style="text-align: center;">{{ $data->MIN_TICKET_QTY }}</td>
                                        <td style="text-align: center;">{{number_format($data->MIN_TICKET_PAYMENT, 0, ",", ".")}}</td>
                                        ...
                                        <td style="text-align: center;">
                                            ...
                                            <a href="javascript:void(0)" onclick="swalApprSMMData({{$data->PROMO_TICKET_PURCHASE_ID_INT}})" class="btn btn-primary">
                                            @elseif($data->COUNT_TRANS_PROMO == 0 && $data->STATUS == 2 && (session('level') == '99' || session('level') == '11'))
                                            <a href="javascript:void(0)" onclick="swalUnapprSMMData({{$data->PROMO_TICKET_PURCHASE_ID_INT}})" class="btn btn-danger">
                                            @else
                                        ...
                                        <td style="text-align: center;">
                                            ...
                                            <a href="javascript:void(0)" onclick="swalApprGMData({{$data->PROMO_TICKET_PURCHASE_ID_INT}})" class="btn btn-primary">
                                            @elseif($data->COUNT_TRANS_PROMO == 0 && $data->STATUS == 3 && (session('level') == '99' || session('level') == '9'))
                                            <a href="javascript:void(0)" onclick="swalUnapprGMData({{$data->PROMO_TICKET_PURCHASE_ID_INT}})" class="btn btn-danger">
                                            @else
                                            <a href="javascript:void(0)" class="btn btn-default">
                                            @endif
                                                @if($data->STATUS <= 2)
                                        ...
                                        <td style="text-align: center;">
                                            ...
                                            <a href="{{ URL('/edit_view_promo/' . base64_encode($data->PROMO_TICKET_PURCHASE_ID_INT)) }}" class="btn btn-primary">
                                            @else
                                            <a href="javascript:void(0)" class="btn btn-default">
                                            @endif
                                                <i>
                                        ...
                                        <td style="text-align: center;">
                                            <!-- Admin Pusat IT, SMM, GM -->
                                            @if($data->COUNT_TRANS_PROMO == 0 && $data->STATUS == 1)
                                            <a href="javascript:void(0)" onclick="swalDeleteData({{$data->PROMO_TICKET_PURCHASE_ID_INT}})" class="btn btn-danger">
                                            @else
                                            <a href="javascript:void(0)" class="btn btn-default">
                                            @endif
                                                <i>
                                        ...
                                        <td style="text-align: center;">
                                            ...
                                            <a href="javascript:void(0)" onclick="swalTerminateData({{$data->PROMO_TICKET_PURCHASE_ID_INT}})" class="btn btn-danger">
                                            @else
                                            <a href="javascript:void(0)" class="btn btn-default">
                                            @endif
                                                <i>
