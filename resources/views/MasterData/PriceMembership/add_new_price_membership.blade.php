...
@section('navbar_header')
    Form Add New Price Membership - <b>{{session('current_project_char')}}</b>
@endsection
...
<div class="container-xxl">
    <div class="row justify-content-center">
        <div class="col-md">
            <div class="card">
                <div class="card-body">
                    <form action="{{ url('save_price_membership') }}" method="post">
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select id="DDL_GROUP" name="DDL_GROUP" class="form-control select2" style="width: 100%;" required>
                                        ...
                                        <option value="{{ $data->MD_GROUP_MEMBERSHIP_ID_INT }}">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select id="DDL_GROUP_TYPE" name="DDL_GROUP_TYPE" class="form-control select2" style="width: 100%;" required>
                                        ...
                                        <option value="{{ $data->MD_GROUP_TYPE_MEMBERSHIP_ID_INT }}">
                                            {{ $data->DESC_CHAR }}
                                        </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select id="DDL_PERIODE" name="DDL_PERIODE" class="form-control select2" style="width: 100%;" required>
                                        ...
                                        <option value="{{ $data->MD_PERIODE_MEMBERSHIP_ID_INT }}">
