...
@section('navbar_header')
    Form Add New Category Revenue - <b>{{session('current_project_char')}}</b>
@endsection

@section('header_title')
    Form Add New Category Revenue
@endsection
...
<div class="container-xxl">
    <div class="row justify-content-center">
        <div class="col-md">
            <div class="card">
                <div class="card-body">
                    <form action="{{ url('save_category_revenue') }}" method="post">
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label>Category Revenue Name <span style="color: red;">*</span></label>
                                    <input type="text" name="MD_CATEGORY_REVENUE_NAME" class="form-control" id="MD_CATEGORY_REVENUE_NAME" placeholder="Enter Category Revenue Name" required>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select id="MD_CATEGORY_REVENUE_SOURCE_ID_INT" name="MD_CATEGORY_REVENUE_SOURCE_ID_INT" class="form-control select2" style="width: 100%;" required>
                                        ...
                                        <option value="{{ $data->MD_CATEGORY_REVENUE_SOURCE_ID_INT }}">
                                            {{ $data->SOURCE_NAME }}
                                        </option>
                                        @endforeach
                                    </select>
