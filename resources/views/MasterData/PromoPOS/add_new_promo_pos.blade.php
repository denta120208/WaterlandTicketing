...
@section('navbar_header')
    Form Add New Promo POS - <b>{{session('current_project_char')}}</b>
@endsection

@section('header_title')
    Form Add New Promo POS
@endsection
...
<div class="container-xxl">
    <div class="row justify-content-center">
        <div class="col-md">
            <div class="card">
                <div class="card-body">
                    <form action="{{ url('save_promo_pos') }}" method="post">
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select id="DDL_CATEGORY" name="DDL_CATEGORY" class="form-control select2" style="width: 100%;" required>
                                        ...
                                        <option value="{{ $data->MD_PRODUCT_POS_CATEGORY_ID_INT }}">
                                            {{ $data->DESC_CHAR }}
                                        </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="TXT_PRODUCT_POS_FREE" class="form-control" id="TXT_PRODUCT_POS_FREE" placeholder="Enter Product POS Free" value="0" required>
        ...
        $('select[name="DDL_CATEGORY"]').on('change', function() {
            ...
            if(subID) {
                if(subID === 'ALL') {
                    ...
                    $('select[name="DDL_PRODUCT"]').append('<option value="ALL">ALL</option>');
                }
                else {
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            {
                                $('select[name="DDL_PRODUCT"]').append("<option value='" + item.MD_PRODUCT_POS_ID_INT + "'>" + item.NAMA_PRODUCT + "</option>");
                            });
                        },
                        error: function() {
