...
@section('navbar_header')
    Report Equipment - <b>{{session('current_project_char')}}</b>
@endsection
                                    ...
                                    <div class="row">
                                        <div class="col-md" style="overflow-x:auto;">
                                            <div style='text-align: center; margin-bottom:30px;'>
                                                ...
                                                <a target="_blank" class="btn btn-danger" href="{{ URL('/view_report_equipment_print/'.base64_encode($START_DATE_PARAM).'/'.base64_encode($END_DATE_PARAM)) }}" onclick="window.open(this.href).print(); return false">
                                                    Print
                                                </a>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            ...
                                            <?php
                                                DataTables::create(array(
                                                    "name" => "reportTable1",
                                                    "dataSource"=>$report->dataStore("equipment_report_table1"),
                                                    "themeBase"=>"bs4",
                                                    "showFooter" => true,
                                                    "cssClass"=>array(
                                                    ...
                                                    "columns" => array(
                                                        "TRANS_RENTAL_EQUIPMENT_ID_INT" => ["label" => "No.", "formatValue" => function($value, $row) { return $value; }, "footerText" => "<b>TOTAL</b>"],
                                                        "TRANS_EQUIPMENT_NO_CHAR" => ["label" => "Transaction Number", "formatValue" => function($value, $row) { return $value; }, "footerText" => "<b>-</b>"],
                                                        ...
                                                        "DEPOSIT_FLOAT" => ["label" => "Deposit", "formatValue" => function($value, $row) { return $value == "-" ? "-" : number_format($value,0,',','.'); }, "footer" => "sum", "footerText" => "<b>@value</b>"],
                                                        ...
                                                        "REFUND_FLOAT" => ["label" => "Refund", "formatValue" => function($value, $row) { return $value == "-" ? "-" : number_format($value,0,',','.'); }, "footer" => "sum", "footerText" => "<b>@value</b>"],
                                                        "REFUND_DESC_CHAR" => ["label" => "Refund Desc", "formatValue" => function($value, $row) { return $value; }, "footerText" => "<b>-</b>"],
                                                        "REFUND_DATE" => ["label" => "Refund Date", "formatValue" => function($value, $row) { return $value == "-" ? "-" : date('Y-m-d', strtotime($value)); }, "footerText" => "<b>-</b>"],
                                    ...
                                    <div class="row">
                                        <div class="col-md" style="overflow-x:auto;">
                                            <div style='text-align: center; margin-bottom:30px;'>
                                                ...
                                                <a target="_blank" class="btn btn-danger" href="{{ URL('/view_report_equipment_details_print/'.base64_encode($START_DATE_PARAM).'/'.base64_encode($END_DATE_PARAM)) }}" onclick="window.open(this.href).print(); return false">
                                                    Print
                                                </a>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            ...
                                            <?php
                                                DataTables::create(array(
                                                    "name" => "reportTable2",
                                                    "dataSource"=>$report->dataStore("equipment_details_report_table1"),
                                                    "themeBase"=>"bs4",
                                                    "showFooter" => true,
                                                    "cssClass"=>array(
                                                        "table"=>"table table-striped table-bordered",
                                                        "td"=>function($row, $colName) {
                                                            if($colName == "TRANS_RENTAL_EQUIPMENT_DETAIL_ID_INT" || $colName == "TRANS_EQUIPMENT_NO_CHAR" || $colName == "MD_EQUIPMENT_WITH_CATEGORY_DESC_CHAR" || $colName == "created_at") {
                                                                return "dt-nowrap text-center";
                                                            }
                                                    ...
                                                    "columns" => array(
                                                        "TRANS_RENTAL_EQUIPMENT_DETAIL_ID_INT" => ["label" => "No.", "formatValue" => function($value, $row) { return $value; }, "footerText" => "<b>TOTAL</b>"],
                                                        "TRANS_EQUIPMENT_NO_CHAR" => ["label" => "Transaction Number", "formatValue" => function($value, $row) { return $value; }, "footerText" => "<b>-</b>"],
                                                        "MD_EQUIPMENT_WITH_CATEGORY_DESC_CHAR" => ["label" => "Description", "formatValue" => function($value, $row) { return $value; }, "footerText" => "<b>-</b>"],
...
<script type="text/javascript">
    ...
    function getExcel() {
        ...
        var url = '{{ url("view_report_equipment_excel/start_date_param/end_date_param") }}';
    ...
    function getDetailsExcel() {
        var start_date = btoa(document.getElementById("txtStartDate").value);
        var end_date = btoa(document.getElementById("txtEndDate").value);
        var url = '{{ url("view_report_equipment_details_excel/start_date_param/end_date_param") }}';
        url = url.replace('start_date_param', start_date);
        url = url.replace('end_date_param', end_date);
        window.location.href = url;
    }
    ...
    function getSubmit() {
        ...
        if(isValid == false) {
            ...
            var start_date = btoa(document.getElementById("txtStartDate").value);
            var end_date = btoa(document.getElementById("txtEndDate").value);
            var url = '{{ url("view_report_equipment/start_date_param/end_date_param") }}';
            url = url.replace('start_date_param', start_date);
            url = url.replace('end_date_param', end_date);
            window.location.href = url;
        }
