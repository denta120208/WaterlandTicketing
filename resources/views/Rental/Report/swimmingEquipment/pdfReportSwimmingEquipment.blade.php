...
<html>
    ...
    <body>
            ...
            <div>
                <center>
                    <div class="headerbawahtengah">
                        <h1><b><label>Swimming Equipment</label></b></h1>
                        <?php
        ...
        <table class="stripe hover compact" id="data_bill_payment" cellspacing="0" width="100%">
            ...
            <tbody>
            @if(count($dataSwimmingEquipment) > 0)
            <?php $qty = 0; $price = 0; $paid = 0; $change = 0; ?>
            @foreach($dataSwimmingEquipment as $data)
                <tr>
                    ...
                    <td style="text-align: right;">{{number_format($data['TOTAL_PAID_FLOAT'], 0, ",", ".")}}</td>
                    ...
                    <td style="text-align: center;">{{$data['RETUR_BY'] == null ? "-" : $data['RETUR_BY']}}</td>
                    <td style="text-align: center;">{{$data['RETUR_AT'] == null ? "-" : date('Y-m-d H:i:s', strtotime($data['RETUR_AT']))}}</td>
                </tr>
                <?php $qty += $data['QTY_INT']; $price += $data['TOTAL_HARGA_FLOAT']; $paid += $data['TOTAL_PAID_FLOAT']; $change += $data['TOTAL_CHANGE_FLOAT']; ?>
            @endforeach
            <tr>
