@extends('Rental.Report.swimmingEquipment.pdfcetak')
...
<html>
    ...
    <body>
            ...
            <div>
                <center>
                    <div class="headerbawahtengah">
                        <h1><b><label>Swimming Equipment Details</label></b></h1>
                        <?php
        ...
        <table class="stripe hover compact" id="data_bill_payment" cellspacing="0" width="100%">
            ...
            <tbody>
            @if(count($dataSwimmingEquipmentDetails) > 0)
            <?php $qty = 0; $price = 0; $totalPrice = 0; ?>
            @foreach($dataSwimmingEquipmentDetails as $data)
                <tr>
                    ...
                    <td style="text-align: right;">{{number_format($data['HARGA_SATUAN_FLOAT'],0,',','.')}}</td>
                ...
                <?php $qty += $data['QTY_INT']; $price += $data['HARGA_SATUAN_FLOAT']; $totalPrice += $data['TOTAL_HARGA_FLOAT']; ?>
            @endforeach
            <tr>
                <td style="text-align: center;"><b>TOTAL</b></td>
                <td style="text-align: center;"><b>-</b></td>
                <td style="text-align: center;"><b>-</b></td>
                <td style="text-align: right;"><b>{{number_format($qty,0,',','.')}}</b></td>
                <td style="text-align: right;"><b>{{number_format($price,0,',','.')}}</b></td>
                <td style="text-align: right;"><b>{{number_format($totalPrice,0,',','.')}}</b></td>
                <td style="text-align: center;"><b>-</b></td>
            </tr>
            @else
            <tr>
