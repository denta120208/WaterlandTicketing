...
@section('navbar_header')
    List Rental Swimming Equipment - <b>{{session('current_project_char')}}</b>
@endsection

@section('header_title')
    List Rental Swimming Equipment
@endsection
                    ...
                    <form>
                        <div class="row" style="padding-left: 5px;">
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <a class="form-control btn btn-info" href="{{ route('rental_swimming_equipment') }}">
                        ...
                        <div class="row" style="padding-left: 5px;">
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    @foreach($dataTransPerlengkapanRenangRent as $data)
                                    <tr>
                                        <td style="text-align: center;">{{$data->TRANS_RENTAL_PERLENGKAPAN_RENANG_ID_INT}}</td>
                                        <td style="text-align: center;">{{$data->TRANS_PERLENGKAPAN_RENANG_NO_CHAR}}</td>
                                        ...
                                        <td style="text-align: center;">
                                            <a href="{{ URL('/print_rental_swimming_equipment/' . $data->TRANS_RENTAL_PERLENGKAPAN_RENANG_ID_INT) }}" class="btn btn-primary" onclick="window.open(this.href).print(); return false">
                                                <i>
                                                    Print
                                                </i>
                                            </a>
                                        ...
                                        <td style="text-align: center;">
                                            <a href="javascript:void(0)" onclick="swalReturData({{$data->TRANS_RENTAL_PERLENGKAPAN_RENANG_ID_INT}})" class="btn btn-success">
                                                <i>
                                                    Retur
                                                </i>
                                            </a>
                                        ...
                                        <td style="text-align: center;">
                                            <a href="javascript:void(0)" onclick="swalCancelData({{$data->TRANS_RENTAL_PERLENGKAPAN_RENANG_ID_INT}})" class="btn btn-danger">
                                                <i>
                                                    Cancel
                                                </i>
                                            </a>
                        ...
                        <div class="row" style="padding-left: 5px;">
                            ...
                            <table id="example2" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    @foreach($dataTransPerlengkapanRenangRentDetails as $data)
                                    <tr>
                                        <td style="text-align: center;">{{$data->TRANS_RENTAL_PERLENGKAPAN_RENANG_DETAIL_ID_INT}}</td>
                                        <td style="text-align: center;">{{$data->TRANS_PERLENGKAPAN_RENANG_NO_CHAR}}</td>
                        ...
                        <div class="row" style="padding-left: 5px;">
                            ...
                            <table id="example3" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    @foreach($dataTransPerlengkapanRenangRetur as $data)
                                    <tr>
                                        <td style="text-align: center;">{{$data->TRANS_RENTAL_PERLENGKAPAN_RENANG_ID_INT}}</td>
                                        <td style="text-align: center;">{{$data->TRANS_PERLENGKAPAN_RENANG_NO_CHAR}}</td>
                                        <td style="text-align: center;">{{$data->CUSTOMER_NAME_CHAR}}</td>
                        ...
                        <div class="row" style="padding-left: 5px;">
                            ...
                            <table id="example4" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    @foreach($dataTransPerlengkapanRenangReturDetails as $data)
                                    <tr>
                                        <td style="text-align: center;">{{$data->TRANS_RENTAL_PERLENGKAPAN_RENANG_DETAIL_ID_INT}}</td>
                                        <td style="text-align: center;">{{$data->TRANS_PERLENGKAPAN_RENANG_NO_CHAR}}</td>
                                        <td style="text-align: center;">{{$data->DESC_CHAR}}</td>
...
<script type="text/javascript">
    ...
    function swalReturData(param1) {
        ...
        allowOutsideClick: false,
            ...
            if (result.isConfirmed) {
                window.location.href = "/retur_rental_swimming_equipment/" + param1;
            }
        });
    }
    ...
    function swalCancelData(param1) {
        ...
        allowOutsideClick: false,
            ...
            if (result.isConfirmed) {
                window.location.href = "/cancel_rental_swimming_equipment/" + param1;
            }
        });
    }
</script>
