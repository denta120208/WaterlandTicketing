...
<table border="0" style="width: 100%; border-collapse: collapse;">
  <tbody>
    ...
    <tr>
      <td style="text-align: center; font-size: 5%;"><b>LOCKER</b></td>
    </tr>
  </tbody>
</table>
<hr />
<table style="width: 100%; border-collapse: collapse;" border="0">
   <tbody>
      <tr>
        ...
        <td style="width: 100%; font-size: 5%; text-align: right;">{{ date('d/m/Y H:i:s', strtotime($dataTransLocker->created_at)) }}</td>
      </tr>
      <tr>
        <td style="width: 25%; font-size: 5%;">Cashier</td>
        <td style="width: 0.1%; font-size: 5%;">:</td>
        <td style="width: 100%; font-size: 5%; text-align: right;">{{ $dataTransLocker->CASHIER_NAME_CHAR }}</td>
      </tr>
      <tr>
        <td style="width: 25%; font-size: 5%;">Customer</td>
        <td style="width: 0.1%; font-size: 5%;">:</td>
        <td style="width: 100%; font-size: 5%; text-align: right;">{{ $dataTransLocker->CUSTOMER_NAME_CHAR }}</td>
      </tr>
      <tr>
        <td style="width: 25%; font-size: 5%;">Trx Num</td>
        <td style="width: 0.1%; font-size: 5%;">:</td>
        <td style="width: 100%; font-size: 5%; text-align: right;">{{ $dataTransLocker->TRANS_LOCKER_NO_CHAR }}</td>
      </tr>
   </tbody>
</table>
<hr />
...
<table style="width: 100%; border-collapse: collapse;" border="0">
   <tbody>
      <tr>
        ...
        <td style="width: 0.1%; font-size: 5%;">:</td>
        <td style="width: 100%; font-size: 5%; text-align: right;">{{ number_format($dataTransLocker->QTY_INT, 0, ",", ".") }}</td>
      </tr>
      <tr>
        <td style="width: 40%; font-size: 5%;">Total Bill</td>
        <td style="width: 0.1%; font-size: 5%;">:</td>
        <td style="width: 100%; font-size: 5%; text-align: right;">{{ number_format($dataTransLocker->TOTAL_HARGA_FLOAT, 0, ",", ".") }}</td>
      </tr>
      <tr>
        <td style="width: 40%; font-size: 5%;">Total Paid</td>
        <td style="width: 0.1%; font-size: 5%;">:</td>
        <td style="width: 100%; font-size: 5%; text-align: right;">{{ number_format($dataTransLocker->TOTAL_PAID_FLOAT, 0, ",", ".") }}</td>
      </tr>
      <tr>
        <td style="width: 40%; font-size: 5%;">Change</td>
        <td style="width: 0.1%; font-size: 5%;">:</td>
        <td style="width: 100%; font-size: 5%; text-align: right;">{{ number_format($dataTransLocker->TOTAL_CHANGE_FLOAT, 0, ",", ".") }}</td>
      </tr>
   </tbody>
</table>
<hr />
