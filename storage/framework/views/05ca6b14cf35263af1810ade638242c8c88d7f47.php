...
<?php $__env->startSection('navbar_header'); ?>
    Form Add New Equipment - <b><?php echo e(session('current_project_char')); ?></b>
...
<div class="container-xxl">
    <div class="row justify-content-center">
        <div class="col-md">
            <div class="card">
                <div class="card-body">
                    <form action="<?php echo e(url('save_equipment')); ?>" method="post">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.mainLayouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/trialwatergroup.metropolitanland.com/html/metland_water/resources/views/MasterData/Equipment/add_new_equipment.blade.php ENDPATH**/ ?>