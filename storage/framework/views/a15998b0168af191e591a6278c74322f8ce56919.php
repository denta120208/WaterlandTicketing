...
<?php $__env->startSection('navbar_header'); ?>
    List Group Membership - <b><?php echo e(session('current_project_char')); ?></b>
...
<div class="modal fade" id="modal-save">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="<?php echo e(url('save_group_membership')); ?>" method="post">
...
<div class="modal fade" id="modal-edit">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="<?php echo e(url('edit_group_membership')); ?>" method="post">
                <?php echo e(csrf_field()); ?>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#example1').DataTable({
            ...
            "ajax":{
                "url": "<?php echo e(url('listTblGroupMembership')); ?>",
                "dataType": "json",
                "type": "POST",
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.mainLayouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/trialwatergroup.metropolitanland.com/html/metland_water/resources/views/MasterData/GroupMembership/groupMembership.blade.php ENDPATH**/ ?>