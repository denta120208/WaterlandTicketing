...
<html>
    ...
    <body>
            ...
            <div>
                <center>
                    <div class="headerbawahtengah">
                        <h1><b><label>Revenue <?php echo e($KATEGORI_PARAM); ?> By Payment Method</label></b></h1>
                        <?php
        ...
        <table class="stripe hover compact" id="data_bill_payment" cellspacing="0" width="100%">
            ...
            <tbody>
            <?php if(count($dataRevenueTicketByPaymentMethod) > 0): ?>
            <?php $i = 1; $qty = 0; $qtyFree = 0; $totalDisc = 0; $total = 0; ?>
            <?php $__currentLoopData = $dataRevenueTicketByPaymentMethod; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td style="text-align: left"><?php echo e($i); ?></td>
                    <td style="text-align: left"><?php echo e($data['PAYMENT_METHOD_DESC_CHAR']); ?></td>
                    <td style="text-align: right"><?php echo e($data['QTY_TICKET_INT']); ?></td>
                    <td style="text-align: right"><?php echo e($data['TICKET_FREE_INT']); ?></td>
                ...
                <?php $i++; $qty += $data['QTY_TICKET_INT']; $qtyFree += $data['TICKET_FREE_INT']; $totalDisc += $data['DISCOUNT_NOMINAL_FLOAT']; $total += $data['TOTAL']; ?>
            ...
            <tr>
                    ...
                    <td style="text-align: right; font-size: 120%;"><b><?php echo e(number_format($totalDisc,0,',','.')); ?></b></td>
                    <td style="text-align: right; font-size: 120%;"><b><?php echo e(number_format($total,0,',','.')); ?></b></td>
                </tr>
            <?php else: ?>
            <tr>
                <td style="text-align: center" colspan="6"><b>No data available</b></td>
            </tr>
            <?php endif; ?>
            </tbody>
        </table>
...
<?php echo $__env->make('Sales.Report.revenueTicketByPaymentMethod.pdfcetak', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/watergroup/public_html/metland_water/resources/views/Sales/Report/revenueTicketByPaymentMethod/pdfReportRevenueTicketByPaymentMethod.blade.php ENDPATH**/ ?>