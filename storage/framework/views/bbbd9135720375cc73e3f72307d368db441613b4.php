...
<?php $__env->startSection('navbar_header'); ?>
    List Price Membership - <b><?php echo e(session('current_project_char')); ?></b>
                        ...
                        <div class="row" style="padding-left: 5px;">
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <a class="form-control btn btn-info" href="<?php echo e(route('add_new_price_membership')); ?>">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#example1').DataTable({
            ...
            "ajax":{
                "url": "<?php echo e(url('listTblPriceMembership')); ?>",
                "dataType": "json",
                "type": "POST",
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.mainLayouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/trialwatergroup.metropolitanland.com/html/metland_water/resources/views/MasterData/PriceMembership/priceMembership.blade.php ENDPATH**/ ?>