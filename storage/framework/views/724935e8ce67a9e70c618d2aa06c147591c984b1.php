...
<?php $__env->startSection('navbar_header'); ?>
    Report Visitors By Time - <b><?php echo e(session('current_project_char')); ?></b>
                ...
                <div class="card-body">
                    <form>
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <select id="ddlKategori" name="ddlKategori" class="form-control select2" style="width: 100%;" required>
                                        ...
                                        <option value="Perhari" <?php echo e($KATEGORI_PARAM == "Perhari" ? "selected" : ""); ?>>Perhari</option>
                                        <option value="Perminggu" <?php echo e($KATEGORI_PARAM == "Perminggu" ? "selected" : ""); ?>>Perminggu</option>
                                        <option value="Perbulan" <?php echo e($KATEGORI_PARAM == "Perbulan" ? "selected" : ""); ?>>Perbulan</option>
                                    </select>
                                </div>
                            </div>
                        ...
                        <?php if($IS_POST == TRUE): ?>
                            <div class="row">
                                <div class="col-md" style="overflow-x:auto;">
                                    <div style='text-align: center; margin-bottom:30px;'>
                                        ...
                                        <a target="_blank" class="btn btn-danger" href="<?php echo e(URL('/view_report_visitors_by_time_print/'.base64_encode($START_DATE_PARAM).'/'.base64_encode($END_DATE_PARAM).'/'.base64_encode($KATEGORI_PARAM))); ?>" onclick="window.open(this.href).print(); return false">
                                            Print
                                        </a>
                                    </div>
                                </div>
                            </div>
                            <?php if($KATEGORI_PARAM == "Perhari"): ?>
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="row">
                                        <div class="col-md-12">
                            ...
                            <?php elseif($KATEGORI_PARAM == "Perminggu"): ?>
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="row">
                                        <div class="col-md-12">
                            ...
                            <?php elseif($KATEGORI_PARAM == "Perbulan"): ?>
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="row">
                                        <div class="col-md-12">
...
<script type="text/javascript">
    ...
    function getExcel() {
        ...
        var url = '<?php echo e(url("view_report_visitors_by_time_excel/start_date_param/end_date_param/kategori_param")); ?>';
    ...
    function getSubmit() {
        ...
        if(isValid == false) {
            ...
            var end_date = btoa(document.getElementById("txtEndDate").value);
            var kategori = btoa(document.getElementById("ddlKategori").value);
            var url = '<?php echo e(url("view_report_visitors_by_time/start_date_param/end_date_param/kategori_param")); ?>';
            url = url.replace('start_date_param', start_date);
            url = url.replace('end_date_param', end_date);
            url = url.replace('kategori_param', kategori);
            window.location.href = url;
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.mainLayouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/watergroup/public_html/metland_water/resources/views/Sales/Report/visitorsByTime/index.blade.php ENDPATH**/ ?>