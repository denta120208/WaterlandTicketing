...
<?php $__env->startSection('navbar_header'); ?>
    Form Add New Promo Membership - <b><?php echo e(session('current_project_char')); ?></b>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('header_title'); ?>
    Form Add New Promo Membership
<?php $__env->stopSection(); ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="FREE_DAYS_INT" class="form-control" id="FREE_DAYS_INT" placeholder="Enter Discount Nominal" value="0" required>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label>Discount (%) <span style="color: red;">*</span></label>
                                    <input type="text" onkeypress="return isNumberWithDecimal(event)" name="DISCOUNT_PERSEN_FLOAT" class="form-control" id="DISCOUNT_PERSEN_FLOAT" placeholder="Enter Discount (%)" required>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label>Discount Nominal <span style="color: red;">*</span></label>
                                    <input type="text" name="DISCOUNT_NOMINAL_NUM" class="form-control" id="DISCOUNT_NOMINAL_NUM" placeholder="Enter Discount Nominal" required>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label>Promo Start <span style="color: red;">*</span></label>
                                    <input type="datetime-local" name="PROMO_START_DTTIME" class="form-control" id="PROMO_START_DTTIME" placeholder="Enter End Promo" required>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.mainLayouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/trialwatergroup.metropolitanland.com/html/metland_water/resources/views/MasterData/PromoMembership/add_new_promo_membership.blade.php ENDPATH**/ ?>