...
<html>
    ...
    <body>
        ...
        <table class="stripe hover compact" id="data_bill_payment" cellspacing="0" width="100%">
            ...
            <tbody>
            <?php if(count($dataVisitorsDetails) > 0): ?>
            <?php $__currentLoopData = $dataVisitorsDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
...
<?php echo $__env->make('Sales.Report.visitors.pdfcetak', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/watergroup/public_html/metland_water/resources/views/Sales/Report/visitors/pdfReportVisitorsDetails.blade.php ENDPATH**/ ?>