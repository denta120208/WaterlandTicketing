...
<html>
    ...
    <body>
            ...
            <div>
                <center>
                    <div class="headerbawahtengah">
                        <h1><b><label>Equipment Details</label></b></h1>
                        <?php
        ...
        <table class="stripe hover compact" id="data_bill_payment" cellspacing="0" width="100%">
            ...
            <tbody>
            <?php if(count($dataEquipmentDetails) > 0): ?>
            <?php $price = 0; ?>
            <?php $__currentLoopData = $dataEquipmentDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td style="text-align: right;"><?php echo e(number_format($data['HARGA_FLOAT'],0,',','.')); ?></td>
                    <td style="text-align: center;"><?php echo e(date('Y-m-d H:i:s', strtotime($data['created_at']))); ?></td>
                </tr>
                <?php $price += $data['HARGA_FLOAT']; ?>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <tr>
                <td style="text-align: center;"><b>TOTAL</b></td>
                <td style="text-align: center;"><b>-</b></td>
                <td style="text-align: center;"><b>-</b></td>
                <td style="text-align: right;"><b><?php echo e(number_format($price,0,',','.')); ?></b></td>
                <td style="text-align: center;"><b>-</b></td>
            </tr>
            <?php else: ?>
            <tr>
                <td style="text-align: center" colspan="5"><b>No data available</b></td>
            </tr>
            <?php endif; ?>
            </tbody>
        </table>
...
<?php echo $__env->make('Rental.Report.equipment.pdfcetak', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/watergroup/public_html/metland_water/resources/views/Rental/Report/equipment/pdfReportEquipmentDetails.blade.php ENDPATH**/ ?>