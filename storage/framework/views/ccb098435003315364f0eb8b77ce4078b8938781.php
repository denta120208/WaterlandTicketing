...
<?php $__env->startSection('navbar_header'); ?>
    Form Ticket Purchase - <b><?php echo e(session('current_project_char')); ?></b>
        ...
        <div class="col-md">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="<?php echo e(url('save_ticket_purchase')); ?>" onsubmit="return validateAmountNotSameForm()" method="post">
                        ...
                        <div class="row">
                            <div class="col-sm-6" style="display: none;">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="HOLIDAY_ID_INT" class="form-control" id="HOLIDAY_ID_INT" value="<?php echo e($HOLIDAY_ID_INT); ?>" readonly>
                                    <input type="hidden" name="IS_HOLIDAY" class="form-control" id="IS_HOLIDAY" value="<?php echo e($IS_HOLIDAY); ?>" readonly>
                                </div>
                            </div>
                            <div class="col-sm-6" style="display: none;">
                                <div class="form-group">
                        ...
                        <a href="<?php echo e(route('ticket_purchase')); ?>" class="btn btn-danger float-right" style="margin-right: 10px;">Back to List</a>
                    </form>
                </div>
            </div>
        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.mainLayouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/trialwatergroup.metropolitanland.com/html/metland_water/resources/views/Sales/TicketPurchase/buy_ticket_purchase.blade.php ENDPATH**/ ?>