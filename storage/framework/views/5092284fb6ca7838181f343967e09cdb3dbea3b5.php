<?php $__env->startSection('navbar_header'); ?>
    Form Add Lot - <b><?php echo e(session('current_project_char')); ?></b>
...
<div class="container-xxl">
    <div class="row justify-content-center">
        <div class="col-md">
            <div class="card">
                <div class="card-body">
                    <form role="form" method="POST" action="<?php echo e(route('lot.lotmaster.savedatalot')); ?>">
                        <?php echo csrf_field(); ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <table class="table table-bordered table-hover dataTable  display compact " id="zone_table" style="padding: 0.5em;">
                        ...
                        <tbody>
                        <?php $__currentLoopData = $listLotZone; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $zone): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td><?php echo e($zone->LOT_ZONE_DESC); ?></td>
                                <td><?php echo e($zone->LOT_ZONE_ID_INT); ?></td>
                            </tr>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <table class="table table-bordered table-hover dataTable  display compact " id="type_table" style="padding: 0.5em;">
                        ...
                        <tbody>
                        <?php $__currentLoopData = $listLotType; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td><?php echo e($type->LOT_TYPE_DESC); ?></td>
                                <td><?php echo e($type->LOT_TYPE_ID_INT); ?></td>
                            </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tbody>
                    </table>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <table class="table table-bordered table-hover dataTable  display compact " id="level_table" style="padding: 0.5em;">
                        ...
                        <tbody>
                        <?php $__currentLoopData = $listLotLevel; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $level): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td><?php echo e($level->LOT_LEVEL_DESC); ?></td>
                                <td><?php echo e($level->LOT_LEVEL_ID_INT); ?></td>
                            </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tbody>
                    </table>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <table class="table table-bordered table-hover dataTable  display compact " id="uom_table" style="padding: 0.5em;">
                        ...
                        <tbody>
                        <?php $__currentLoopData = $listUom; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $uom): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td><?php echo e($uom->UNIT_NAME); ?></td>
                                <td><?php echo e($uom->UNIT_CODE); ?></td>
                                <td><?php echo e($uom->id_unit); ?></td>
                            </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tbody>
                    </table>
...
<?php echo $__env->make('layouts.mainLayouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/trialwatergroup.metropolitanland.com/html/metland_water/resources/views/page/lotmaster/create.blade.php ENDPATH**/ ?>